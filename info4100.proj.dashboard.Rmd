...
#######################################
    ...
    output$student_quiz_trend = renderPlot({
        student_quiz <- df_by_lecture %>%
          ...
          summarise(quiz_score = first(QUIZ_SCORE), .groups = "drop")
    
        ggplot(student_quiz, aes(x = QUIZ_NUMBER, y = quiz_score)) +
          geom_line(color = "#2C7FB8", linewidth = 1.5) +
          geom_point(color = "#2C7FB8", size = 3) +
          scale_y_continuous(limits = c(0, 20)) +
          scale_x_continuous(breaks = 1:10) +
          labs(
            title = paste("Quiz Score Trend for Student", input$student_id),
            x = "Quiz Number",
...
![Instructor 1](dahsboard_shots/Screenshot%202026-04-18%20at%208.57.12%20PM.png)

![Instructor 2](dahsboard_shots/Screenshot%202026-04-18%20at%208.57.21%20PM.png)

![Instructor 3](dahsboard_shots/Screenshot%202026-04-18%20at%208.57.26%20PM.png)

![Instructor 4](dahsboard_shots/Screenshot%202026-04-18%20at%208.57.30%20PM.png)

![Instructor 5](dahsboard_shots/Screenshot%202026-04-18%20at%208.57.34%20PM.png)

**Student Dashboard**

![Student 1](dahsboard_shots/Screenshot%202026-04-18%20at%208.58.04%20PM.png)

![Student 2](dahsboard_shots/Screenshot%202026-04-18%20at%208.58.16%20PM.png)

![Student 3](dahsboard_shots/Screenshot%202026-04-18%20at%208.58.20%20PM.png)

![Student 4](dahsboard_shots/Screenshot%202026-04-18%20at%208.58.28%20PM.png)

![Student 5](dahsboard_shots/Screenshot%202026-04-18%20at%208.58.44%20PM.png)
...
-   What was the biggest challenge you faced? How did you address it?
    -   The biggest challenge we faced was deciding which data visualizations we wanted to implement them. We addressed this by doing some research and seeing some example dashboards and how we can do something similar.
